...
public class UserResponse extends RepresentationModel<UserResponse> {
    ...
    public UserResponse(Long id, String firstName, String lastName, String fullName, String email, LocalDate subscriptionActivation, LocalDate endOfSubscription, Integer visitsHall) {
        this.id = id;
