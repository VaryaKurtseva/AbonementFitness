...
public class NotificationListener {
    ...
    private String buildDescription(String eventType,JsonNode payload){
        ...
        String visits = payload.get("visitsHall").asText();
        String idUser = payload.get("userId").asText();
        String process = payload.get("process").asText();
        String subscriptionActivation = payload.get("subscriptionActivation").asText();
        switch (eventType){
            case "user.created":
